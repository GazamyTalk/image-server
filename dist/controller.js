...
function getImageData(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const redirectUrl = `${server_1.serverConfig.currentServerPath}/404.png`;
        if (typeof filename !== "string") {
            res.redirect(redirectUrl);
            return;
        }
        const content = yield service.getImageData(filename);
...
function addImageData(req, res) {
    if (req.is('image/png')) {
        ...
        req.on('end', () => (() => __awaiter(this, void 0, void 0, function* () {
            ...
            const filename = yield service.addImageData(content);
